            ...
            <div className="sm:container sm:mx-auto md:flex flex justify-center"> 
                <div className="w-11/12 flex justify-center md:justify-between items-center pt-8 md:pt-14 md:pb-10">
                    ...
                    <div className="flex justify-between w-10/12 md:w-3/12 md:justify-between md:flex">
                        ...
                        <a href="https://drive.google.com/file/d/1dPJL4zqIr1dbolv9dQHq5Wf_tyGtUbYj/view?usp=sharing" className="font-inter font-medium text-center text-transparent bg-clip-text cursor-pointer bg-gradient-to-r from-black to-black hover:from-indigo-500 hover:to-pink-500" >Resume</a>
